...
function (_Component) {
  ...
  function AddPlayerForm() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AddPlayerForm)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      input: ""
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAddPlayer", function (e) {
      e.preventDefault();

      _this.props.addPlayer(_this.state.input);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleValueChange", function (e) {
      _this.setState({
...
},{"react":16}],2:[function(require,module,exports){
"use strict";
...
var _AddPlayerForm = _interopRequireDefault(require("./AddPlayerForm"));
...
function (_Component) {
  ...
  function App() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleScoreChange", function (index, delta) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleRemovePlayer", function (id) {
      _this.setState(function (prevState) {
        return {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "newPlayerId", function () {
      return _this.state.players.length + 1;
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleAddPlayer", function (name) {
      _this.setState(function (prevState) {
        return {
          players: [].concat(_toConsumableArray(prevState.players), [{
            name: name,
            score: 0,
            id: _this.newPlayerId()
          }])
        };
      });
    });
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_Player.default, {
          ...
          changeScore: _this2.handleScoreChange,
          removePlayer: _this2.handleRemovePlayer
        });
      }), _react.default.createElement(_AddPlayerForm.default, {
...
},{"./AddPlayerForm":1,"./Header":4,"./Player":5,"react":16}],3:[function(require,module,exports){
"use strict";
...
var Counter = function Counter(props) {
  return _react.default.createElement("div", {
    ...
    onClick: function onClick() {
      return props.changeScore(props.index, -1);
    }
...
var Header = function Header(props) {
  return _react.default.createElement("header", null, _react.default.createElement(_Stats.default, {
...
},{"./Stats":6,"react":16}],5:[function(require,module,exports){
"use strict";
...
var Player = function Player(props) {
  ...
  }, "\u2716"), props.name), _react.default.createElement(_Counter.default, {
    index: props.index,
    score: props.score,
...
},{"./Counter":3,"react":16}],6:[function(require,module,exports){
"use strict";
...
var Stats = function Stats(props) {
  ...
  return _react.default.createElement("table", {
    className: "stats"
  }, _react.default.createElement("tbody", null, _react.default.createElement("tr", null, _react.default.createElement("td", null, "Players:"), _react.default.createElement("td", null, totalPlayers)), _react.default.createElement("tr", null, _react.default.createElement("td", null, "Total Points:"), _react.default.createElement("td", null, totalScore))));
};
...
},{"./components/App":2,"react":16,"react-dom":13}],8:[function(require,module,exports){
/*
object-assign
(c) Sindre Sorhus
@license MIT
